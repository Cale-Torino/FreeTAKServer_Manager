...
namespace FreeTAKServer_Manager
{
    ...
    {
        public static class CMDInstance
        {
            public static void PIDKill(int PID)
            {
                ...
                {
                    MessageBox.Show(Exception.Message, "Could not run Kill CMD PID", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
            ...
            public static int CMDStartServer(string CMD_command, string CMD_workingdir)
            {
                ...
                {
                    MessageBox.Show(Exception.Message, "Could not run command successfully", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return 1;
                }
            }
